...
motion = tio.Compose([tio.transforms.RandomMotion(num_transforms=2, degrees=(-2,2), translation=(-2,2))])
...
plt.savefig('/home/students/studhoene1/imagequality/tsne_figs_3Slices_Ntxent/4GPU_exp1.png')
plt.show()